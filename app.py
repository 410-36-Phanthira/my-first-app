...
st.write("นี่คือเว็บแอปพลิเคชันแรกในชีวิตของ'ดิฉัน เขียนด้วยภาษา Python ค่ะ")

st.divider() # เส้นคั่นแบ่งสัดส่วนให้สวยงาม

# ส่วนข้อมูลส่วนตัว (Profile Info)
st.header("👤 ข้อมูลส่วนตัว")
st.write("**ชื่อ-นามสกุล:** นางสาวภัณฑิรา ภัทรเดชมงคล")
st.write("**ชั้น ม.4/10** เลขที่ 36")
